...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-v1.30.3-10B981?style=flat-square" alt="Version">
...
- 🎙️ **语音输入与语音摘要** — 支持平台原生语音消息输入（通过飞书 STT 转文字），以及通过智能语音合成（集成微软 Edge-TTS 或本地化部署的 MOSS-TTS 语音合成伴生进程）将 Agent 的文本摘要以语音形式自动播报回传。
