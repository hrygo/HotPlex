...
- 🛡️ **生产级可靠性** — 5 状态会话状态机、JWT ES256 认证、SSRF 防护、崩溃恢复
...
HotPlex 位于前端客户端和后端 AI Coding Agent 之间，将协议差异抽象为统一的 AEP v1 WebSocket 层。
...
| **架构设计** | [网关架构](docs/architecture/Worker-Gateway-Design.md) · [Agent 配置设计](docs/architecture/Agent-Config-Design.md) |
