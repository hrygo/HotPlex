...
| 133 | **RES-008** | per_user max_total_memory_mb 限制 | 🟡 P1 | 🟢 PASS | `session/pool.go` | PoolManager.AcquireMemory/ReleaseMemory，512MB/worker，默认 2GB/user |
| 134 | **RES-009** | Worker 可用性 99% 崩溃率控制 | 🟡 P1 | 🟢 PASS | `internal/metrics/metrics.go` | WorkerCrashesTotal counter + WorkerMemoryBytes gauge |
...
| P0 | RES-005 | RLIMIT_AS syscall.Setrlimit | ✅ PASS |
| P0 | RES-008 | per_user max_total_memory_mb | ✅ PASS |
| P0 | RES-009 | Worker 崩溃率控制 | ✅ PASS |
