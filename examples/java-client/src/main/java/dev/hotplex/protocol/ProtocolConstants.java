...
public final class ProtocolConstants {
    ...
    public static final long PING_PERIOD_MS = 54000;
    public static final long PONG_WAIT_MS = 5000;
    public static final int MAX_MISSED_PONGS = 3;

    // Reconnect defaults (milliseconds) — includes jitter to avoid thundering herd
    public static final long RECONNECT_BASE_DELAY_MS = 1000;
    public static final long RECONNECT_JITTER_MS = 2000;
