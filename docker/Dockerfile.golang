# ==============================================================================
# HotPlex Go Development Stack (2026)
# ==============================================================================
...
# Permissions setup
USER root
RUN mkdir -p ${GOPATH}/bin && chown -R hotplex:hotplex ${GOPATH}
...
LABEL org.opencontainers.image.title="HotPlex Go"
