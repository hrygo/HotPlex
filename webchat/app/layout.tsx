...
const outfit = localFont({
    src: [
        ...
        {
            path: "../node_modules/@fontsource/outfit/files/outfit-latin-900-normal.woff2",
            weight: "900",
        },
    ],
    display: "swap",
...
const jetbrainsMono = localFont({
    src: [
        ...
        {
            path: "../node_modules/@fontsource/jetbrains-mono/files/jetbrains-mono-latin-800-normal.woff2",
            weight: "800",
        },
    ],
    display: "swap",
    ...
    return (
        ...
        >
            <head>
              ...
              (function() {
                try {
                  var saved = localStorage.getItem('hotplex-theme');
                  var theme = saved;
                  if (!theme) {
