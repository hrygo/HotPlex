      ...
      <div className="mx-auto max-w-6xl">
        ...
        {!loading && !error && keys.length > 0 && (
          <div className="relative mb-5">
            ...
            <input
              type="text"
              placeholder={t('admin:api_keys.placeholder.search', { defaultValue: 'Search by user ID or description...' })}
              value={query}
        ...
        {!loading && !error && keys.length > 0 && filteredKeys.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 text-center bg-[var(--bg-surface)] border border-[var(--border-subtle)] rounded-[var(--radius-md)]">
