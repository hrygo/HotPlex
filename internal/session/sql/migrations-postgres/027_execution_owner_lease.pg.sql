...
ALTER TABLE "execution_inputs" ADD COLUMN "lease_until"        BIGINT  NOT NULL DEFAULT 0;
...
ALTER TABLE "execution_inputs" ADD COLUMN "started_at"         BIGINT;
ALTER TABLE "execution_inputs" ADD COLUMN "finished_at"        BIGINT;
...
CREATE INDEX IF NOT EXISTS "idx_execution_owner_runtime"
    ON "execution_inputs"("owner_instance_id", "runtime_status", "lease_until");

CREATE UNIQUE INDEX IF NOT EXISTS "idx_execution_one_active_per_session"
