...
func TestFormatTurnSummaryRich_Full(t *testing.T) {
	...
	require.Contains(t, lines[0], "🔄 Turn #3")
	require.Contains(t, lines[1], "🤖 Model Sonnet")
	require.Contains(t, got, "🧠 Context 24% · 48.4K/200K")
	require.Contains(t, got, "🔧 Tools 12 (")
	require.Contains(t, got, "📂")
	require.Contains(t, got, "🌿 Branch feat/117-turn-summary")
