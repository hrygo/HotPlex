...
func (m *mockBridge) StartSession(context.Context, string, string, string, string, worker.WorkerType, []string, string, string, map[string]string, string, string, ...string) error {
	return m.err
}
